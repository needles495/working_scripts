...
if [[ $ip == 10\.3\.* ]]; then
    ...
    sed "s/INSERT_PHONE_NUMBER/$PHONENUMBER1/g" /home/scripts/zabbix_call/camera_not_work.call > /tmp/camera_not_work_phone1.call
    sed "s/INSERT_PHONE_NUMBER/$PHONENUMBER2/g" /home/scripts/zabbix_call/camera_not_work.call > /tmp/camera_not_work_phone2.call
    cp /tmp/camera_not_work_phone* /var/spool/asterisk/outgoing/
fi
